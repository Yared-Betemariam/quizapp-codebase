...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        hankenGrotesk: ["HankenGrotesk-Regular", "sans-serif"],
        ...
        "hankenGrotesk-semibold": ["HankenGrotesk-SemiBold", "sans-serif"],
        "hankenGrotesk-light": ["HankenGrotesk-Light", "sans-serif"],
      },
      colors: {
        primary: {
          100: "#0061FF0A",
